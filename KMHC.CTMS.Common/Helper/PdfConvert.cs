...
namespace KMHC.CTMS.Common.Helper
{
    ...
    public class PdfConvert
    {
        ...
        {
            string programAppDominFilesPath = AppDomain.CurrentDomain.BaseDirectory;
            string filePath = Path.Combine(programAppDominFilesPath, @"wkhtmltopdf\wkhtmltopdf.exe");
