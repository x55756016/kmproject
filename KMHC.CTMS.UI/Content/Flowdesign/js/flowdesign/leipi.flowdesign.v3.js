   ...
   $.fn.Flowdesign = function(options)
    ...
    if(processData.list)
    {
        $.each(processData.list, function(i,row) 
        {
            ...
            .html('<span class="process-flag badge ' + badge + '" name=' + row.process_name + '><i class="' + icon + ' icon-white"></i></span>&nbsp;' + row.process_name)
        ...
        getProcessInfo:function()
        {
            try{
              /*连接关系*/
                ...
                //            aProcessData[processVal[0]] = {"process_Name": "", "top": 0, "left": 0, "process_to": [] };
                //        }
                ...
                //        aProcessData[pId]["process_Name"] = name;
                //    }
                //});
                ...
                $("#leipi_process_info input[type=hidden]").each(function(i) {
                    var processVal = $(this).val().split(",");
                    if (processVal.length == 2) {
                        $.each(processData, function(name, value) {
                            if ($(this)[0].ID == processVal[0]) {
                                $(this)[0].ProcessTo.push(processVal[1]);
                                //return false;
                            }
                        });
                    }
